var u = new Url('https://kcws.spohr.eu', localStorage.getItem('authkey'), '/kc_kundeninfo/', '/kc_rechnung/', '/kc_get_katalogadressen/', '/kc_set_katalogadressen/', '/kc_get_pdf/', '/artikelimg/', '/img/', 'http://spohr.eu/search?sSearch=', 1, 20, 'desc');
